...
window.LOCALES['fr'] = {
  ...
  'btn.menu': 'Menu',
  'btn.menu.title': 'Sauver, ouvrir, exporter, imprimer',
  'btn.expandDesc': 'Étendre desc.',
  'btn.expandDesc.title': 'Garder toutes les descriptions toujours étendues',
  ...
  'modal.type.estimateDuration': 'Estimer la durée selon le nombre de mots (155 mots/min)',
